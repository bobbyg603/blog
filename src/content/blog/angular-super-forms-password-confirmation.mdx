...
By the end of this article, you should have something that approximates the following.

![Error-Tailored Reactive Form](/pictures/blog/angular-super-forms-password-confirmation/form-validation-demo.gif)

## Origin Story

At [BugSplat](https://bugsplat.com), we were able to switch our production web app's authentication provider to [Cognito](https://aws.amazon.com/cognito/) in just over a week — if that's not heroic I'm not sure what is! Part of our authentication switch included recreating some components that didn't fit our desired UI/UX.
