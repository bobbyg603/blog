---
title: "How To Build a Strongly Typed Angular Super Form"
description: "Enforce Form Control Types via your Data Models"
pubDate: 2022-06-09
author: "Bobby Galli"
heroImage: "/pictures/blog/how-to-build-a-strongly-typed-angular-14-super-form/hero.jpg"
tags: ["Tutorial", "Development"]
---

*Originally published in [Better Programming](https://medium.com/better-programming/how-to-build-a-strongly-typed-angular-14-super-form-86837965a0e5)*

## Typed Forms

> "Typed forms ensure that the values inside of form controls, groups, and arrays are type safe across the entire API surface. This enables safer forms, especially for deeply nested complex cases." — [Angular Blog](https://blog.angular.io/angular-v14-is-now-available-391a6db736af)
...
![Type-Ahead Suggestions with Angular 14 Forms](/pictures/blog/how-to-build-a-strongly-typed-angular-14-super-form/type-ahead-suggestions.gif)
...
![Error at declaration time](/pictures/blog/how-to-build-a-strongly-typed-angular-14-super-form/error-at-declaration.png)
