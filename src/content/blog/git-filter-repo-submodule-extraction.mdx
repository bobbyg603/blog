...
*Originally published in [Level Up Coding](https://levelup.gitconnected.com/git-filter-repo-submodule-extraction-fb84de4c0ed6)*

*"I will always choose a lazy person to do a difficult job because a lazy person will find an easy way to do it."* — [Frank B. Gilbreth Sr](https://quoteinvestigator.com/tag/frank-gilbreth-sr/)
